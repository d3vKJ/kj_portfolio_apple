  ...
  return (
    <header className="global-nav">
      <nav className="global-nav__content" aria-label="글로벌">
        <Link to="/" className="global-nav__logo" aria-label="Apple">
          <img
        ...
        <ul className="global-nav__list">
          {nav_items.map((item) => (
            <li key={item.path} className="global-nav__item">
              <NavLink
                to={item.path}
                className={({ isActive }) =>
                  isActive
        ...
        <div className="global-nav__actions">
          <button type="button" className="global-nav__action" aria-label="검색">
          ...
          <button type="button" className="global-nav__action" aria-label="장바구니">
