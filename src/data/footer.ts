    ...
    groups: [
      {
        ...
        links: [
          ...
          { label: '그룹 예약', to: '/store' },
          { label: 'Apple 캠프', to: '/store' },
          { label: 'Apple Store 앱', to: '/store' },
    ...
    groups: [
      {
        title: '비즈니스',
        links: [
          { label: 'Apple과 비즈니스', to: '/store' },
          { label: '비즈니스를 위한 제품 쇼핑하기', to: '/store' },
        ],
      },
      {
        title: '교육',
        links: [
          { label: 'Apple과 교육', to: '/store' },
          { label: '초중고용 제품 쇼핑하기', to: '/store' },
          { label: '대학 생활을 위한 제품 쇼핑하기', to: '/store' },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        links: [
          ...
          { label: '교육', to: '/support' },
          { label: '환경', to: '/support' },
          { label: '개인정보 보호', to: '/support' },
          { label: '공급망 혁신', to: '/support' },
        ],
      },
      {
        title: 'Apple 정보',
        links: [
          ...
          { label: 'Apple 리더십', to: '/support' },
          { label: '채용 안내', to: '/support' },
          { label: '윤리 및 규정 준수', to: '/support' },
          { label: '이벤트', to: '/support' },
          { label: '일자리 창출', to: '/support' },
...
export const footer_corporate: string[] = [
  '대표자: Mark Lee | 주소: 대한민국 서울특별시 강남구 영동대로 517 | 전화번호: 080-330-8877 | 사업자등록번호: 120-81-84429',
